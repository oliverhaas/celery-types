...
class Backend:
    ...
    def chord_error_from_stack(self, callback: Any, exc: Exception | None = None) -> Exception: ...
    ...
    def fail_from_current_stack(self, task_id: str, exc: Exception | None = None) -> None: ...
    ...
    def prepare_exception(self, exc: Exception, serializer: str | None = None) -> Any: ...
    def prepare_expires(self, value: float | timedelta | None, type: type | None = None) -> float | None: ...
