...
class Scheduler:
    ...
    def apply_async(
        self, entry: ScheduleEntry, producer: kombu.Producer | None = None, advance: bool = True, **kwargs: Any
    ) -> Any: ...
    def apply_entry(self, entry: ScheduleEntry, producer: kombu.Producer | None = None) -> Any: ...
    @property
    ...
    def schedules_equal(
        self, old_schedules: dict[str, ScheduleEntry], new_schedules: dict[str, ScheduleEntry]
    ) -> bool: ...
    ...
    def tick(
        self, event_t: type[event_t] = ..., min: Callable[..., Any] = ..., heappop: Callable[..., Any] = ..., heappush: Callable[..., Any] = ...
    ) -> float: ...
