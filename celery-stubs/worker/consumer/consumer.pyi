...
class Consumer:
    ...
    def connection_for_read(self, heartbeat: float | None = None) -> kombu.Connection: ...
    def connection_for_write(self, heartbeat: float | None = None) -> kombu.Connection: ...
    ...
    def on_connection_error_after_connected(self, exc: Exception, interval: float) -> None: ...
    def on_connection_error_before_connected(self, exc: Exception, interval: float) -> None: ...
